...
//DXL_ID1 motor id for the rotative scoop (XM)
//DXL_ID2 motor id for the endless screw (XL)
//DXL_ID3 motor id for the laser (XM)
...
void loop() {
  ...
  if (Serial.available() > 0) {
    ...
    dxl_wb.getPresentPositionData(dxl_id1, &Position);
